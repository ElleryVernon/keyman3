		...
		<div>
			<div className="flex items-center justify-between mb-3">
				<h1 className="text-sm font-medium">
					검색 결과 <span className="text-[#8B8B8B]">({results.length}명)</span>
				</h1>
				<select
					className="bg-[#1A1D24] border border-[#282B31] rounded-lg px-2 py-1 text-xs"
					value={sortBy}
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
					{isLoading
						? [...Array(4)].map((_, i) => (
								<div
									key={i}
									className="bg-[#1A1D24] border border-[#282B31] rounded-2xl p-3 animate-pulse"
								>
									{/* 로딩 상태 스켈레톤 UI */}
									<div className="flex items-start space-x-3">
										<div className="w-10 h-10 rounded-full bg-[#282B31]" />
										<div className="flex-1">
											<div className="h-4 bg-[#282B31] rounded w-24 mb-2" />
											<div className="space-y-1">
												<div className="h-3 bg-[#282B31] rounded w-32" />
												<div className="h-3 bg-[#282B31] rounded w-28" />
												<div className="h-3 bg-[#282B31] rounded w-20" />
											</div>
											<div className="mt-4 space-y-2">
												<div className="space-y-1">
													<div className="h-2 bg-[#282B31] rounded w-16" />
													<div className="flex gap-1">
														<div className="h-4 bg-[#282B31] rounded w-16" />
														<div className="h-4 bg-[#282B31] rounded w-16" />
													</div>
												</div>
												<div className="space-y-1">
													<div className="h-2 bg-[#282B31] rounded w-16" />
													<div className="flex gap-1">
														<div className="h-4 bg-[#282B31] rounded w-14" />
														<div className="h-4 bg-[#282B31] rounded w-14" />
													</div>
												</div>
											</div>
						...
						: sortedResults.map((result) => {
								...
								return (
									<div
										key={result.id}
										className="group relative bg-[#1A1D24] border border-[#282B31] rounded-2xl p-3 
									hover:bg-[#282B31] cursor-pointer pb-10"
										onClick={() =>
									...
									>
										...
										<div className="flex items-start space-x-3">
											{imageSrc ? (
												...
												<div className="w-10 h-10 rounded-full bg-[#282B31] flex items-center justify-center text-sm font-medium">
											...
											<div className="flex-1">
												<div className="flex items-start justify-between mb-2">
													<div>
														...
														<div className="flex items-center space-x-1.5 mt-0.5">
															<Building className="w-3 h-3 text-[#8B8B8B]" />
															<p className="text-xs text-[#8B8B8B]">{result.company}</p>
														</div>
														<div className="flex items-center space-x-1.5 mt-0.5">
															<Building className="w-3 h-3 text-[#8B8B8B]" />
															<p className="text-xs text-[#8B8B8B]">{result.department}</p>
														</div>
														<div className="flex items-center space-x-1.5 mt-0.5">
															<Briefcase className="w-3 h-3 text-[#8B8B8B]" />
															<p className="text-xs text-[#8B8B8B]">{result.position}</p>
														</div>
														<div className="flex items-center space-x-1.5 mt-0.5">
															<div
													...
													<div className="flex flex-col items-end space-y-1">
														...
														<div className="flex items-center space-x-1.5">
															<Phone className="w-3 h-3 text-[#8B8B8B]" />
															<p className="text-xs text-[#8B8B8B]">{result.dphone}</p>
														</div>
														<div className="flex items-center space-x-1.5">
															<Phone className="w-3 h-3 text-[#8B8B8B]" />
															<p className="text-xs text-[#8B8B8B]">{result.mphone}</p>
														</div>
														<div className="flex items-center space-x-1.5">
												...
												<div className="space-y-2">
													<div>
														...
														<div className="flex flex-wrap gap-1">
															{result.highlights.map((highlight) => (
																<span
																	key={highlight}
																	className="flex items-center space-x-1 bg-[#282B31] px-1.5 py-0.5 rounded text-[10px]"
																>
																	<span>{highlight}</span>
																</span>
															))}
													...
													<div>
														...
														<div className="flex flex-wrap gap-1">
															{result.skills.map((skill) => (
																<span
																	key={skill}
																	className="bg-[#282B31] px-1.5 py-0.5 rounded text-[10px]"
																>
																	{skill}
																</span>
															))}
													...
													<div>
														...
														<ul className="space-y-0.5 text-[10px] text-[#8B8B8B]">
															{result.projects.map((project) => (
																<li key={project} className="flex items-center space-x-1">
																	<span className="w-0.5 h-0.5 rounded-full bg-[#3A3E45]" />
																	<span>{project}</span>
																</li>
															))}
														</ul>
				...
				<div className="space-y-2">
					{isLoading
						? [...Array(4)].map((_, i) => (
								<div
									key={i}
									className="bg-[#1A1D24] border border-[#282B31] rounded-xl p-3 animate-pulse"
								>
									{/* 로딩 상태 스켈레톤 UI */}
									<div className="flex items-center space-x-4">
										...
										<div className="flex-1">
											<div className="flex items-center justify-between">
												<div className="h-4 bg-[#282B31] rounded w-24" />
												<div className="h-4 bg-[#282B31] rounded w-16" />
											</div>
											<div className="mt-2 flex gap-2">
												<div className="h-3 bg-[#282B31] rounded w-24" />
												<div className="h-3 bg-[#282B31] rounded w-24" />
											</div>
											<div className="mt-2 flex gap-1">
												<div className="h-5 bg-[#282B31] rounded w-16" />
												<div className="h-5 bg-[#282B31] rounded w-16" />
												<div className="h-5 bg-[#282B31] rounded w-16" />
											</div>
										</div>
						...
						: sortedResults.map((result) => {
								...
								return (
									<div
										key={result.id}
										className="group relative bg-[#1A1D24] border border-[#282B31] rounded-xl p-3 
									hover:bg-[#282B31] cursor-pointer"
												...
												<div className="flex items-center justify-between">
													...
													<div className="flex items-center space-x-4">
														<div className="flex items-center space-x-1">
															<Phone className="w-3 h-3 text-[#8B8B8B]" />
															<span className="text-xs text-[#8B8B8B]">회사: {result.dphone}</span>
														</div>
														<div className="flex items-center space-x-1">
															<Phone className="w-3 h-3 text-[#8B8B8B]" />
															<span className="text-xs text-[#8B8B8B]">개인: {result.mphone}</span>
														</div>
														<div className="flex items-center space-x-1">
															<Mail className="w-3 h-3 text-[#8B8B8B]" />
															<span className="text-xs text-[#8B8B8B]">{result.email}</span>
														</div>
													</div>
												</div>
												<div className="flex items-center space-x-4 mt-1 text-xs text-[#8B8B8B]">
													<div className="flex items-center space-x-1">
