...
export default async function ProfilePage() {
	...
	return (
		<main className="min-h-screen bg-[#121318] text-white p-8">
			<div className="max-w-3xl mx-auto">
				{/* Navigation Bar */}
				<nav className="sticky top-0 z-10 bg-[#121318] px-3 py-2 mb-8">
				...
				<Tabs defaultValue="info" className="w-full">
					<TabsList className="w-full bg-[#1c1f2a] border-b border-[#252836]">
						<TabsTrigger
							value="info"
							className="flex-1 data-[state=active]:bg-[#252836] text-gray-300 data-[state=active]:text-white"
						>
							기본정보
						</TabsTrigger>
						<TabsTrigger
